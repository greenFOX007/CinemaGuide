...
export default function Footer() {
  return (
    <footer className="flex justify-between py-12 bg-main-black max-md:flex-col">
      <div className="flex max-md:flex-col max-md:mb-8">
        <p className="text-[18px] font-bold mr-3 max-md:mb-2">
      ...
      <div className="flex gap-6">
        <Link
          href="/"
          className="size-9 border border-white rounded-lg flex justify-center items-center"
        >
          <svg
            width="19"
            height="11"
